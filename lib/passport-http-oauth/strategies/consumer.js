 ...
 * previously issued request token and verifier.  This infomation will be
 ...
 *     callbackURL  URL to redirect the user to after authorization 
 *
 ...
 *
 *     scheme        always set to `OAuth`
 *     requestToken  previously obtained request token
  ...
  this._consumer(consumerKey, function(err, consumer, consumerSecret) {
    ...
    function validate(tokenSecret, ok) {
      ...
      if (self._validate) {
        ...
        // TODO: Make this signature token, timestamp, nonce
